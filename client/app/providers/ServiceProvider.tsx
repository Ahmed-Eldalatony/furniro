...
import { PostRepository } from '@/features/posts/repositories'; // Import concrete repository
...
export const ServiceProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const postService = useMemo(() => new PostService(postRepository), [postRepository]);
